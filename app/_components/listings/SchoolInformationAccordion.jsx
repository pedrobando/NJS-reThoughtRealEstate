              ...
              >
                {school.rating && (
                  <div className="flex-shrink-0">
                    <span className="rounded-full bg-gray-200 p-2 text-gray-500">
                      {" "}
                      {school.rating}{" "}
                    </span>
                  </div>
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="truncate text-sm text-gray-500">
                    {school.address.deliveryLine} {school.address.city},{" "}
                    {school.address.state} {school.address.zip}
                  </p>
                  <p className="truncate text-sm text-gray-500">
                    {school.admission} | {school.level}{" "}
                  </p>
                  <p className="truncate text-sm text-gray-500">
                    {school.totalStudents && (
                      <>{school.totalStudents} Students |</>
                    )}{" "}
                    {school.studentTeacherRatio} Student/Teacher Ratio{" "}
                  </p>
                </div>
              </div>
            ))}
