            ...
            <ScrollArea className="h-[400px]">
              {countResults() === 0 ? (
                ...
                <div className="p-1">
                  ...
                  {results.result.responses[2]?.result?.zipcodes?.length >
                    0 && (
                    <div className="mt-2">
                      ...
                      <div className="space-y-1">
                        {results.result.responses[2].result.zipcodes.map(
                          (zip) => (
                            <div
                              key={zip.id}
                  ...
                  {results.result.responses[0]?.result?.["postal-cities"]
                    ?.length > 0 && (
                    <div className="mt-2">
                      <div className="px-2 py-1.5 text-xs font-semibold text-muted-foreground">
                      ...
                      <div className="space-y-1">
                        {results.result.responses[0].result[
                          "postal-cities"
                        ].map((city) => (
                          <div
                            key={city.id}
                  ...
                  {results.result.responses[1]?.result?.counties?.length >
                    0 && (
                    <div className="mt-2">
                      <div className="px-2 py-1.5 text-xs font-semibold text-muted-foreground">
                      ...
                      <div className="space-y-1">
                        {results.result.responses[1].result.counties.map(
                          (county) => (
                            <div
                              key={county.id}
                              className="flex items-center gap-2 rounded-sm px-2 py-1.5 hover:bg-accent cursor-pointer"
                  ...
                  {results.result.responses[3]?.result?.states?.length > 0 && (
                    <div className="mt-2">
                      ...
                      <div className="space-y-1">
                        {results.result.responses[3].result.states.map(
                          (state) => (
                            <div
                              key={state.id}
                              className="flex items-center gap-2 rounded-sm px-2 py-1.5 hover:bg-accent cursor-pointer"
                  ...
                  {results.result.responses[4]?.result?.schools?.length > 0 && (
                    <div className="mt-2">
                      ...
                      <div className="space-y-1">
                        {results.result.responses[4].result.schools
                          .slice(0, 5)
                          .map((school) => (
                            <div
                              key={school.id}
                        ...
                        {results.result.responses[4].result.total > 5 && (
                          <div className="px-2 py-1.5 text-xs text-center text-blue-600 hover:underline cursor-pointer">
                            View all {results.result.responses[4].result.total}{" "}
                            schools
                          </div>
                        )}
                      </div>
                  ...
                  {results.result.responses[5]?.result?.schools?.length > 0 && (
                    <div className="mt-2">
                      <div className="px-2 py-1.5 text-xs font-semibold text-muted-foreground">
                        SCHOOL DISTRICTS (
                        {results.result.responses[5].result.total})
                      </div>
                      <div className="space-y-1">
                        {results.result.responses[5].result.schools
                          .slice(0, 5)
                          .map((school) => (
                            <div
                              key={school.id}
                        ...
                        {results.result.responses[5].result.total > 5 && (
                          <div className="px-2 py-1.5 text-xs text-center text-blue-600 hover:underline cursor-pointer">
                            View all {results.result.responses[5].result.total}{" "}
                            school districts
                          </div>
                        )}
                      </div>
                  ...
                  {results.result.responses[6]?.result?.listings?.length >
                    0 && (
                    <div className="mt-2">
                      <div className="px-2 py-1.5 text-xs font-semibold text-muted-foreground">
                      ...
                      <div className="space-y-1">
                        {results.result.responses[6].result.listings
                          .slice(0, 5)
                          .map((listing) => (
                            <div
                              key={listing.id}
                        ...
                        {results.result.responses[6].result.total > 5 && (
                          <div className="px-2 py-1.5 text-xs text-center text-blue-600 hover:underline cursor-pointer">
                            View all {results.result.responses[6].result.total}{" "}
                            properties
                          </div>
                        )}
                      </div>
