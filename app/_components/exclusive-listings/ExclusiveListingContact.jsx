    ...
    <div className="flex md:px-6 justify-center">
     {photoUrl && <img
      ...
      <div className="flex-col md:px-6 content-end">
        ...
        <p className="text-center md:text-left px-6 py-5 md:py-8 text-gray-500 text-basis ">
        ...
        <Carousel className="w-full px-6 max-w-sm mx-auto ">
          <CarouselContent className="-ml-1  place-items-end">
            ...
            <CarouselItem className="pl-1 basis-1/3 hover:scale-95 transition text-center">
            <ExclusiveListingsDrawer listing={listing} dayOfWeek={dayOfWeek} dayOfMonth={dayOfMonth} month={month} />
            </CarouselItem>
            <CarouselItem className="pl-1 basis-1/3 hover:scale-95 transition text-center">
            <ExclusiveListingsDrawer listing={listing} dayOfWeek={dayOfWeek1} dayOfMonth={dayOfMonth1} month={month1} />
            </CarouselItem>
            <CarouselItem className="pl-1 basis-1/3 hover:scale-95 transition text-center">
            <ExclusiveListingsDrawer listing={listing} dayOfWeek={dayOfWeek2} dayOfMonth={dayOfMonth2} month={month2} />
            </CarouselItem>
            <CarouselItem className="pl-1 basis-1/3 hover:scale-95 transition text-center">
            <ExclusiveListingsDrawer listing={listing} dayOfWeek={dayOfWeek3} dayOfMonth={dayOfMonth3} month={month3} />
            </CarouselItem>
            <CarouselItem className="pl-1 basis-1/3 hover:scale-95 transition text-center">
            <ExclusiveListingsDrawer listing={listing} dayOfWeek={dayOfWeek4} dayOfMonth={dayOfMonth4} month={month4} />
            </CarouselItem>
            <CarouselItem className="pl-1 basis-1/3 hover:scale-95 transition text-center">
            <ExclusiveListingsDrawer listing={listing} dayOfWeek={dayOfWeek5} dayOfMonth={dayOfMonth5} month={month5} />
            </CarouselItem>
            <CarouselItem className="pl-1 basis-1/3 hover:scale-95 transition text-center">
            <ExclusiveListingsDrawer listing={listing} dayOfWeek={dayOfWeek6} dayOfMonth={dayOfMonth6} month={month6} />
            </CarouselItem>
          </CarouselContent>
          <CarouselPrevious />
          <CarouselNext />
