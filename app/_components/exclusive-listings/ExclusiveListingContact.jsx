...
console.log(`Today is ${dayOfWeek}, ${month} ${dayOfMonth}`);
  ...
  return (
    ...
    <h2 className='text-center md:text-left font-heading text-4xl md:text-6xl font-bold bg-gradient-to-r from-reGreen to-lime-600  text-transparent bg-clip-text py-2'>Ready to go see it?</h2>
    <p className='text-center md:text-left px-6 py-5 md:py-8 text-gray-500 text-basis '>Let's a closer look at {listing.address.deliveryLine} together. Let me know what works best for you. </p>
